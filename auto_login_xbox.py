...
详细信息：
    ...
    process_path: C:\Users\damon\Desktop\Xbox.lnk
    Xbox username, password, ip
    ...
    点击"登录"，弹出窗体2转一会儿才显示"下一页"

    窗体2:
        class_name: Windows.UI.Core.CoreWindow
        title_name: Xbox Identity Provider
        "下一页"width: left+333
        "下一页"height: top+561

        "让我们一起玩吧"width: left+336
        "让我们一起玩吧"height: top+564
    ...
    窗体3：
        ...
        title_name: 登录
        "Microsoft 账户"width: left+134
        "Microsoft 账户"height: top+339
        "继续"width: left+334
        "继续"height: top+478

    点击"Microsoft 账户"，然后点击"继续"，弹出窗体4

    窗体4：
        class_name: Windows.UI.Core.CoreWindow
        title_name: Microsoft 帐户
        账户框width: left+120
        账户框height: top+215
        "下一步"width: left+562
        "下一步"height: top+557
    ...
    点击账户框，输入用户名，然后点击"下一步"，转转转，还是窗体4
    点击密码框，输入密码，然后点击"登录"，转转转，回到窗体2
    点击"让我们一起玩吧"，到窗体1
    点击 选项，再点击"连接"，转转转
    点击 添加一个设备框，输入IP，点击"连接"，转转转
...
class SoftwareOperation(object):
    ...
    def get_software_position(self):
        ...
        :rtype: str
        """
        path = r'C:\Users\damon\Desktop\Xbox.lnk'
        return path
...
class WindowOperation(object):
    ...
    def get_child_window_handle(self, parent):
        """
        获得parent的所有子窗口句柄
        :return: 子窗口句柄列表
        """
        hwnd_chile_list = []
        if parent:
            win32gui.EnumChildWindows(parent, lambda hwnd, param: param.append(hwnd), hwnd_chile_list)
...
def get_window_rect(class_name, title_name):
